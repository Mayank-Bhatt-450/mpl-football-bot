...
def dis(pt1,pt2=( 39 , 40 , 40 )):#191,7,5 
...
pixno=0
no=[ (254, 255, 255) ,
(130, 137, 119) , ]#[(153, 165, 177),(74, 83, 92),(77, 86, 95)]
for y in range(900):
    for x in range(1440):
        d=img.getpixel((x,y))
        if (d not in no)and d[1]<200 :#(d[0]==d[1]==d[2])!=True and (d[0]!=0 and d[1]!=148 and d[2]!=255)and (d not in no)and d[0]>=112 and d[2]<=20:#and d[0]>=180  and d[2]<d[1] and d[1]<70 :#and(dis(d,(232,31,9))<=64.08587988004847 ):
