...
#while True:
    ...
    goal=[]
    print((tell_color_dis(img.getpixel((720,731)),( 105 , 144 , 51 ),200  ) ,
        tell_color_dis(img.getpixel((743,713)),( 105 , 144 , 51 ),200  )))
    if (tell_color_dis(img.getpixel((720,731)),( 105 , 144 , 51 ),95.29428104561154  ) and
        tell_color_dis(img.getpixel((743,713)),( 105 , 144 , 51 ),95.29428104561154  ))==False:
        for i in range(100):
            for k in range(31):
                find=[True,False]
                for g in range(10):
